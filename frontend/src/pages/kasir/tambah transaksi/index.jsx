  ...
  return (
    <Container>
      <Stack direction='row' spacing={4}>
        <Button cursor={"pointer"} onClick={() => navigate("/dashboard/kasir/transaksi")} leftIcon={<IoIosArrowBack />} bg="#AAB2BA" color="white">
          Kembali Ke Transaksi
        </Button>
        <Button rightIcon={<MdPayment />} bg={"green.600"} color={"white"}
      ...
      <br></br>
      <Heading text="Tambah Transaksi Baru" /> {/* memanggil komponen heading */}<br></br>
